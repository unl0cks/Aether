...
use ruffle_render_wgpu::texture_pool_policy::OffscreenTexturePoolPolicy;
use std::borrow::Cow;
...
pub struct LaunchOptions {
    ...
    pub offscreen_texture_pool_policy: OffscreenTexturePoolPolicy,
}
...
impl ActivePlayer {
    ...
    pub fn new(
        ...
        let opt = match &content {
            ...
            PlayingContent::Bundle(_, bundle) => {
                ...
                Cow::Owned(LaunchOptions {
                    ...
                    offscreen_texture_pool_policy: opt.offscreen_texture_pool_policy,
                })
            }
        };
        ...
        let renderer = WgpuRenderBackend::new_with_offscreen_texture_pool_policy(
            descriptors,
            movie_view,
            opt.offscreen_texture_pool_policy,
        )
        ...
        window.set_title(&format!("Aether - {readable_name}"));
