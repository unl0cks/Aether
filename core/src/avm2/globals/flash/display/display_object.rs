...
pub fn initialize_for_allocator<'gc>(
    ...
    dobj.set_skip_next_enter_frame(true);
...
pub fn hit_test_object<'gc>(
    ...
    {
        let intersects = dobj.hit_test_object(rhs_dobj);
        #[cfg(feature = "aether_metrics")]
        if intersects {
            crate::aether_diagnostics::record_movement_collision(dobj, rhs_dobj);
        }
        return Ok(intersects.into());
    }
